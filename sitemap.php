...
<div class="bg-color-docs">
    ...
    <div class="container">
        <h1 class="title-brends">Разделы сайта</h1>
    </div>
    <div class="block-site-map">
        <div class="container">
            <div class="col-md-6">
                <ul class="ul-treefree">
                    <li class="parent-category-map">Категория товаров №1</li>
                    <li class="parent-category-map">Категория товаров №2</li>
                    <li class="parent-category-map">Категория товаров №3
                        <ul class="child-category-map">
                            <li>
                                Подкатегория товаров №3.1
                                <ul class="child-category-map">
                                    <li>Подкатегория товаров №3.1</li>
                                </ul>
                            </li>
                            <li>
                                Подкатегория товаров №3.1
                    ...
                    <li class="parent-category-map">Категория товаров №15</li>
                    <ul class="child-category-map">
                        <li>
                            Подкатегория товаров №3.1
                            <ul class="child-category-map">
