...
<div class="bg-color-docs">
    <div class="category-top-banner contact-banner">
    </div>
    ...
    <div class="container">
        <h1 class="title-brends">Техническая документация</h1>
    </div>
    <div class="collapses-docs">
        <div class="container">
            <div class="name-category-docs">
                <span>
                    Фотоэлектрические системы
                </span>
            </div>
            <div class="col-md-2">
                <a class="collaps-doc" data-toggle="collapse" href="#collapseExample" aria-expanded="false" aria-controls="collapseExample">
                    <i class="fa fa-file-pdf-o" aria-hidden="true"></i>
                    <span class="title-button-doc">
                Контроллеры заряда
                </span>
                </a>
            </div>
            <div class="col-md-2">
                <a class="collaps-doc" data-toggle="collapse" href="#collapseExample1" aria-expanded="false" aria-controls="collapseExample">
                    <i class="fa fa-file-pdf-o" aria-hidden="true"></i>
                    <span class="title-button-doc">
                Инверторы
                </span>
        ...
        <div class="collapse" id="collapseExample">
            <div class="head-title-block-doc">
                <div class="container">
                    <p class="title-name-block">
                        Контроллеры заряда
            ...
            <div class="container">
                <div class="card doc-block">
                    <ul>
                        <?php for ($i = 0; $i < 10; $i++) { ?>
                            <li>
                                <a href="#" class="view-pdf-file">
                                    <i class="fa fa-file-pdf-o" aria-hidden="true"></i>
                                    Контроллер управления уличным светодиодным освещением ASL1524LD
                                </a>
                                <a href="#" class="down-pdf-file">
    ...
    <div class="collapses-docs">
        <div class="container">
            ...
            <div class="col-md-2">
                <a class="collaps-doc" data-toggle="collapse" href="#collapseExample2" aria-expanded="false" aria-controls="collapseExample">
                    <i class="fa fa-file-pdf-o" aria-hidden="true"></i>
                    <span class="title-button-doc">
                        Солнечные батареи
                    </span>
            ...
            <div class="col-md-2">
                <a class="collaps-doc" data-toggle="collapse" href="#collapseExample3" aria-expanded="false" aria-controls="collapseExample">
                    <i class="fa fa-file-pdf-o" aria-hidden="true"></i>
                    <span class="title-button-doc">
